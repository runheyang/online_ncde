...
from evoocc.evaluation import compute_dense_rayiou_with_pcds, evaluate_dense_occ  # noqa: E402
...
def main() -> None:
    ...
    if model_variant == "dense":
        model = EvoOccAligner(**common_kwargs).to(device)
    else:
        raise ValueError(
