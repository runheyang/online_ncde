...
默认评估 alocc3d_surroundocc 的 val split：
    ...
    conda run -n neural_ode python tests/online_ncde/eval_surroundocc_saved_logits_miou.py

仅快速检查前 100 个样本：

    conda run -n neural_ode python tests/online_ncde/eval_surroundocc_saved_logits_miou.py --limit 100
"""
...
from online_ncde.evaluation.dense_occ import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--canonical-info",
        default="configs/online_ncde/canonical_infos_val_full.pkl",
