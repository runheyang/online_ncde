...
用法示例：
    python tests/evoocc/eval_occ_detailed_stats.py \
...
from evoocc.metrics import OCC3D_DYNAMIC_OBJECT_IDX, apply_free_threshold  # noqa: E402
