...
from evoocc.config import config_output_subdir, load_config_with_base, resolve_path  # noqa: E402
from evoocc.data.ego_warp_list import (  # noqa: E402
...
from evoocc.data.scene_delta import build_scene_delta_ctrl  # noqa: E402
from evoocc.data.time_series import compute_segment_dt, cumulative_tau  # noqa: E402
from evoocc.losses import build_loss  # noqa: E402
from evoocc.models.func_g import FuncG  # noqa: E402
from evoocc.models.heads import CtrlProjector  # noqa: E402
...
def main() -> None:
    ...
    model = EvoOccEulerNextFastAligner(
        num_classes=data_cfg["num_classes"],
